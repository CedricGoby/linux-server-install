...
# Description : Opérations post installation pour Debian 11 server (bullseye).
...
printf "\n%s\n" "Script de post installation pour Debian 11 server (bullseye)"
...
NOTIFY_NO_UPDATES="1"
CUSTOM_SUBJECT=" $(hostname) [logwatch] - $SYSTEM: $NUM_PACKAGES mise(s)-&agrave-jour disponible(s)"
EOF
)
